  ...
  if (is404) {
    return (
      <div className="bg-gray-100 h-screen flex justify-center items-center">
        <center className="text-center items-center justify-center flex flex-col">
        <svg
            class="emoji-404 "
          ...
          <Link
            to="/"
            className="text-gray-500 font-mono text-xl bg-gray-200 p-3 rounded-md hover:shadow-md mt-6 inline-block"
          >
            Kembali ke home
          </Link>
        </center>
